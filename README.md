...
## ✒️ 메모리v2 기능 개선과 관련하여
 ...
 다음은 해당 작업의 결과 보고서와 새로운 계층형 메모리 시스템 프로토타입에 대한 자료입니다.
- **REPORT** : [L.A.S. Memory V2 (Result Report) ](https://docs.google.com/document/d/18ILmrwDFlmWfqEnGTj1-TT7385jOK3mhoyg0MUQDJ-E/)
- **README** : [L.A.S. Memory V2 (xMemory Project) ](./LAS_Memory_V2/README.md)
